...
public class People {
    public static List<Person> getPeople() {
        ...
        people.add(new Person("Sam", "John", "11/07/95", R.drawable.person2));
        people.add(new Person("Ryan", "Gort", "11/07/64", R.drawable.person3));
        people.add(new Person("Joe", "Dim", "11/07/84", R.drawable.person4));
